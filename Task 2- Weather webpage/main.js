document.addEventListener('DOMContentLoaded', function () {
    ...
    async function checkweather(city) {
        ...
        if (response.status == 404) {
            ...
            if (Math.round(data.main.temp) > 25 && data.weather[0].main == "Clouds") {
                document.getElementById("s").innerHTML = "Humid and a Cloudy day on cards Hope your Ac's working fine!";
            }
            ...
            if (Math.round(data.main.temp) < 10) {
                document.getElementById("s").innerHTML = "Chilly weather , Pile up with your jackets and scarfs.Enjoy your coffee!";
            }
            if (data.weather[0].main == "Rain") {
                document.getElementById("s").innerHTML = "Carry your umbrella folks its going to pour !";
            }
